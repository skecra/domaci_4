    ...
    <section class="content">
      ...
      <div class="row mb-3">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Novi proizvodjac</h5>
                      ...
                      <form  enctype="multipart/form-data" action="dodajProizvodjaca.php" id="forma" method="POST">
        ...
        <table class="table table-bordered table-striped">
            ...
            $sqlProizvodjaci = "SELECT * FROM proizvodjac";
            $res = mysqli_query($db_conn, $sqlProizvodjaci);
            $broj = 1;
            while($proizvodjac = mysqli_fetch_assoc($res)){
                $id = $proizvodjac['ID'];
                $naziv = $proizvodjac['naziv'];
                echo "<tr>";
                echo "<td>$broj</td>";
                echo "<td>$naziv</td>";
                echo "<td class=\"text-center\"> <a href=\"izmijeniproizvodjaca.php?id=$id\" class='mr-2'> <i class=\"nav-icon fas fa-edit\"> </i> </a> <a href=\"izbrisiproizvodjaca.php?id=$id\"> <i class=\"nav-icon fas fa-trash\"> </i> </a> </td>";
                echo "</tr>";
                $broj++;
            }
