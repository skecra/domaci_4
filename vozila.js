            ...
            if(godina.value==''){
              ...
              if(klasa.value==''){
                ...
                if(cijena.value==''){
                  ...
                  if(profilna.value==''){
                    document.getElementById('alert_profilna').classList.remove('d-none')
                    profilna.classList.add('crveno')
                    profilna.classList.remove('zeleno')
                    greske++
                    } else {
                      document.getElementById('alert_profilna').classList.add('d-none')
                      profilna.classList.add('zeleno')
                      profilna.classList.remove('crveno')
                    }
