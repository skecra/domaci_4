    ...
    <section class="content">
      ...
      <div class="row mb-3">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Novi model</h5>
                      ...
                      <form  enctype="multipart/form-data" action="dodajModel.php" id="forma" method="POST">
                        <label for="model">Model:</label>
                        <input class="form-control" type="text" placeholder="Unesite model..." name="model" id="model">
        ...
        <table class="table table-bordered table-striped">
            ...
            $sqlModel = "SELECT model.*, proizvodjac.naziv FROM model join proizvodjac on model.proizvodjac_id=proizvodjac.ID";
            $res = mysqli_query($db_conn, $sqlModel);
            $broj = 1;
            while($model = mysqli_fetch_assoc($res)){
                $id = $model['ID'];
                $naziv = $model['model'];
                $proizvodjac = $model['naziv'];
                echo "<tr>";
                echo "<td>$proizvodjac</td>";
                echo "<td>$naziv</td>";
                echo "<td class=\"text-center\"> <a href=\"izmijeniModel.php?id=$id\" class='mr-2'> <i class=\"nav-icon fas fa-edit\"> </i> </a> <a href=\"izbrisiModel.php?id=$id\"> <i class=\"nav-icon fas fa-trash\"> </i> </a> </td>";
                echo "</tr>";
                $broj++;
            }
