...
$sql = "SELECT * FROM drzave WHERE ID=$id";
$res = mysqli_query($db_conn, $sql);

$drzava = mysqli_fetch_assoc($res);
$id = $drzava['ID'];
$naziv = $drzava['naziv'];
...
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-6 offset-3 text-center">
        <h3>Izmijeni drzavu</h3>
        <form  enctype="multipart/form-data" action="updatedrzavu.php" id="forma" method="POST">
